...
function ImportantNotUrgent() {
  ...
  const quadrantType = 'important-not-urgent'; // Define the quadrant type for this component
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-pink-50 via-blue-50 to-green-50">
      ...
      <div className="p-4 flex items-center bg-white shadow-sm">
        ...
        <h1 className="text-2xl font-bold text-gray-800">{t('important_not_urgent.title')}</h1>
      </div>
      ...
      <div className="flex-1 px-4 py-6 space-y-4 overflow-auto">
        {tasks.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-64 text-gray-500">
            ...
            <p className="text-lg">{t('important_not_urgent.no_tasks')}</p>
            <p className="text-sm">{t('important_not_urgent.add_task')}</p>
          </div>
        ) : (
          tasks.map((task) => (
            <div 
            ...
            <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
              ...
              >
                <div className="flex items-center">
                  <span className="text-xs mr-1">{t('important_not_urgent.schedule')}</span>
